...
Uso: enviar o comando na legenda de uma imagem

*Educação:*
\`\`\`/busquelivro <palavras chaves>\`\`\`
_Busca no nosso catálogo de livros_
ex: /busquelivro sociedade do cansaço

\`\`\`/baixarlivro <id>\`\`\`
_Baixa um livro_
Ex: /baixarlivro 57591

\`\`\`/procure <palavras chaves>\`\`\`
_Faz uma pesquisa_
Ex: /procure como fazer redção

\`\`\`/pdf <link>\`\`\`
_Disponibiliza o pdf de uma pagina apartir de um link_
Ex: /pdf https://pedroaf0.medium.com/bot-de-whatsapp-ajuda-estudantes-com-internet-limitada-7fcc938441b6
